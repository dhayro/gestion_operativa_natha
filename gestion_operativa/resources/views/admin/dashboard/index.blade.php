...
<div class="row layout-top-spacing">
        ...
        <a href="{{ route('empleados.index') }}" style="text-decoration: none; color: inherit;">
            <div class="card widget-stats">
                <div class="card-header">
                    <h5>{{ $isAdminOrSupervisor ? 'Total Empleados' : 'Tu Información' }}</h5>
                </div>
                <div class="card-body">
                    <div class="stat-number">{{ $totalEmpleados }}</div>
                    <div class="stat-label">{{ $isAdminOrSupervisor ? 'Activos en el sistema' : 'Registros personales' }}</div>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <a href="{{ route('cuadrillas.index') }}" style="text-decoration: none; color: inherit;">
            <div class="card widget-stats">
                <div class="card-header">
                    <h5>{{ $isAdminOrSupervisor ? 'Cuadrillas Activas' : 'Tus Cuadrillas' }}</h5>
                </div>
                <div class="card-body">
                    <div class="stat-number">{{ $totalCuadrillas }}</div>
                    <div class="stat-label">{{ $isAdminOrSupervisor ? 'En operación' : 'Asignadas a ti' }}</div>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <a href="{{ route('vehiculos.index') }}" style="text-decoration: none; color: inherit;">
            <div class="card widget-stats">
                <div class="card-header">
                    <h5>{{ $isAdminOrSupervisor ? 'Vehículos Disponibles' : 'Vehículos de tu cuadrilla' }}</h5>
                </div>
                <div class="card-body">
                    <div class="stat-number">{{ $totalVehiculos }}</div>
                    <div class="stat-label">{{ $isAdminOrSupervisor ? 'En la flota' : 'Disponibles' }}</div>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <a href="{{ route('papeletas.index') }}" style="text-decoration: none; color: inherit;">
            <div class="card widget-stats">
                <div class="card-header">
                    <h5>{{ $isAdminOrSupervisor ? 'Papeletas Activas' : 'Tus Papeletas' }}</h5>
                </div>
                <div class="card-body">
...
<div class="row layout-top-spacing">
    <div class="col-12">
        <h4 class="mb-4 mt-4">
            <i class="fas fa-layer-group me-2"></i> {{ $isAdminOrSupervisor ? 'Cuadrillas Activas del Sistema' : 'Mis Cuadrillas' }}
        </h4>
    </div>
</div>
...
<div class="row layout-spacing">
    ...
    <div class="col-12">
        <div class="alert alert-info" role="alert">
            ...
            {{ $isAdminOrSupervisor ? 'No hay cuadrillas activas en este momento.' : 'No estás asignado a ninguna cuadrilla en este momento.' }}
        </div>
    </div>
    @endforelse
</div>
