...
<div class="seperator-header layout-top-spacing">
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="">Gestión de Servicios Eléctricos</h4>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#servicioModal" id="btnNuevoServicio">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <div class="table-responsive full-height-row">
                    <table id="serviciosTable" class="table table-striped table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nombre</th>
...
<div class="modal fade" id="servicioModal" tabindex="-1" aria-labelledby="servicioModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content">
            <form id="servicioForm" action="" method="POST">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="servicioModalLabel">Crear/Editar Servicio Eléctrico</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" maxlength="50" placeholder="Ingrese el nombre del servicio eléctrico" required>
                        </div>
                    </div>
                    <div class="row">
...
@section('scripts')
    ...
    $(document).ready(function() {
        var table = $('#serviciosTable').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: '{{ route('servicios-electricos.data') }}',
            columns: [
        ...
        $('#btnNuevoServicio').click(function() {
            ...
            $('#servicio_id').val('');
            $('#servicioModalLabel').text('Nuevo Servicio Eléctrico');
            setupFormValidation();
        });
        ...
        $('#servicioForm').on('submit', function(e) {
            ...
            var url = id ? '/servicios-electricos/' + id : '/servicios-electricos';
    ...
    window.editServicioElectrico = function(id) {
        Swal.fire({
            title: 'Cargando...',
            allowOutsideClick: false,
        ...
        $.get('/servicios-electricos/' + id, function(data) {
            Swal.close();
            $('.is-invalid, .is-valid').removeClass('is-invalid is-valid');
            $('.invalid-feedback').remove();
            ...
            $('#servicioModalLabel').text('Editar Servicio Eléctrico');
    ...
    window.deleteServicioElectrico = function(id) {
        Swal.fire({
            title: '¿Estás seguro?',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '/servicios-electricos/' + id,
                    type: 'DELETE',
                    data: { _token: '{{ csrf_token() }}' },
                    success: function(res) {
                        Swal.fire('Eliminado!', 'Servicio Eléctrico eliminado correctamente.', 'success');
                        $('#serviciosTable').DataTable().ajax.reload();
                    },
                    error: function(xhr) {
                        var message = 'No se pudo eliminar el servicio eléctrico';
