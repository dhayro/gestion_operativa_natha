    ...
    <ul class="collapse submenu list-unstyled {{ ($catName === 'maestros') ? 'show' : '' }}" id="maestros" data-bs-parent="#accordionExample">
        ...
        {{-- Puedes agregar más opciones aquí --}}
            ...
            <li class="menu {{ Request::routeIs('calendar') ? 'active' : '' }}">
                <a href="{{getRouterValue()}}app/calendar" aria-expanded="{{ Request::routeIs('calendar') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ Request::routeIs('chat') ? 'active' : '' }}">
                <a href="{{getRouterValue()}}app/chat" aria-expanded="{{ Request::routeIs('chat') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ Request::routeIs('mailbox') ? 'active' : '' }}">
                <a href="{{getRouterValue()}}app/mailbox" aria-expanded="{{ Request::routeIs('mailbox') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ Request::routeIs('todolist') ? 'active' : '' }}">
                <a href="{{getRouterValue()}}app/todolist" aria-expanded="{{ Request::routeIs('todolist') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ Request::routeIs('notes') ? 'active' : '' }}">
                <a href="{{getRouterValue()}}app/notes" aria-expanded="{{ Request::routeIs('notes') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ Request::routeIs('scrumboard') ? 'active' : '' }}">
                <a href="{{getRouterValue()}}app/scrumboard" aria-expanded="{{ Request::routeIs('scrumboard') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ Request::routeIs('contacts') ? 'active' : '' }}">
                <a href="{{getRouterValue()}}app/contacts" aria-expanded="{{ Request::routeIs('contacts') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ isset($submenu) && $submenu === 'invoice' ? 'active' : '' }}">
                <a href="#invoice" data-bs-toggle="collapse" aria-expanded="{{ isset($submenu) && $submenu === 'invoice' ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ isset($submenu) && $submenu === 'invoice' ? 'show' : '' }}" id="invoice" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ isset($submenu) && $submenu === 'ecommerce' ? 'active' : '' }}">
                <a href="#ecommerce" data-bs-toggle="collapse" aria-expanded="{{ isset($submenu) && $submenu === 'ecommerce' ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ isset($submenu) && $submenu === 'ecommerce' ? 'show' : '' }}" id="ecommerce" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ isset($submenu) && $submenu === 'blog' ? 'active' : '' }}">
                <a href="#blog" data-bs-toggle="collapse" aria-expanded="{{ isset($submenu) && $submenu === 'blog' ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ isset($submenu) && $submenu === 'blog' ? 'show' : '' }}" id="blog" data-bs-parent="#accordionExample">
