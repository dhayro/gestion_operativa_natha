                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown" style="min-width: 280px;">
                    <div class="user-profile-section" style="padding: 25px 20px; border-bottom: 1px solid #e9ecef;">
                        <div class="media mx-auto">
                            ...
                            <div class="media-body">
                                ...
                                <p class="mb-2 text-primary fw-semibold" style="font-size: 0.95rem;">{{ auth()->user()->roles->first()->nombre ?? 'Usuario' }}</p>
                    ...
                    <div class="dropdown-item">
                        <a href="{{getRouterValue()}}app/mailbox">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg> <span>Bandeja de entrada</span>
                        </a>
                    </div>
                    <div class="dropdown-item">
